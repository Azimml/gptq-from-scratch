...
def parse_args():
    ...
    parser.add_argument("--quantize", action="store_true", help="Run GPTQ quantization")
    parser.add_argument("--bits", type=int, default=4, choices=[2, 3, 4], help="Quantization bits")
    parser.add_argument("--naive", action="store_true", help="Use naive RTN instead of GPTQ")
    parser.add_argument("--wandb", action="store_true", help="Log to Weights & Biases")
    parser.add_argument("--stride", type=int, default=512, help="Stride for perplexity evaluation")
    parser.add_argument("--n-samples", type=int, default=128, help="Number of calibration samples")
    parser.add_argument("--block-size", type=int, default=128, help="GPTQ column block size")
    parser.add_argument(
